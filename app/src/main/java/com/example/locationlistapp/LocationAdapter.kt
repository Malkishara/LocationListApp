...
class LocationAdapter : RecyclerView.Adapter<LocationAdapter.LocationViewHolder>(){
    ...
    class LocationViewHolder(var view: View):RecyclerView.ViewHolder(view)
    {
        ...
        private var loc=view.findViewById<TextView>(R.id.tvLoc)
        private var long=view.findViewById<TextView>(R.id.tvLong)
        private var lati=view.findViewById<TextView>(R.id.tvLati)
