...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var loc_name: EditText
    ...
    private lateinit var sqLiteHelper: Sql
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initView()
        initRecycleView()
        sqLiteHelper= Sql(this)
        add.setOnClickListener { addLocation() }
        view.setOnClickListener { getLocations() }
    ...
    {
        val loc = loc_name.text.toString()
